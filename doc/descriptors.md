# Support for Output Descriptors in Tipuscoin Core

Since Tipuscoin Core v0.17, there is support for Output Descriptors. This is a
...
on Tipuscoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Tipuscoin Core wallets, a convenience function `combo` is
