 ...
 */
static const char* BITCOIN_PID_FILENAME = "tipuscoind.pid";
...
void Shutdown(InitInterfaces& interfaces)
{
    ...
    RenameThread("tipuscoin-shutoff");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/tipuscoin-project/tipuscoin>";
    const std::string URL_WEBSITE = "<https://tipuscoin.org>";
...
static void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread("tipuscoin-loadblk");
...
bool AppInitMain(InitInterfaces& interfaces)
{
    ...
    if (gArgs.IsArgSet("-datadir") && !fs::path(gArgs.GetArg("-datadir", "")).is_absolute()) {
        LogPrintf("Warning: relative datadir option '%s' specified, which will be interpreted relative to the " /* Continued */
                  "current working directory '%s'. This is fragile, because if tipuscoin is started in the future "
                  "from a different location, it will be unable to locate the current data files. There could "
                  "also be data loss if tipuscoin is started while in a temporary directory.\n",
