...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " tipuscoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  tipuscoin-tx [options] <hex-tx> [commands]  Update hex-encoded tipuscoin transaction\n" +
            "or:     tipuscoin-tx [options] -create [commands]   Create hex-encoded tipuscoin transaction\n" +
            "\n";
