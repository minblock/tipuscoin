...
"""Verify that starting tipuscoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start tipuscoin with -h for help text")
        ...
        self.log.info("Start tipuscoin with -version for version information")
        ...
        self.log.info("Start tipuscoind with -fakearg to make sure it does not start")
